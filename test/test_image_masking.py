...
class ImageMaskingTestCase(unittest.TestCase):
    ...
    def test_apply_mask_to_image(self):
        ...
        self.assertTrue(np.all(masked_array[0, 0] == [0, 0, 0]))  # Top-left should be black
    ...
    def test_apply_mask_custom_color(self):
        ...
        red_color = (255, 0, 0)
        masked_img = self.masker.apply_mask_to_image(self.test_image_path, mask, red_color)
    ...
    def test_validate_rectangles_match_within_tolerance(self):
        ...
        self.assertTrue(self.masker.validate_rectangles_match(rectangles1, rectangles2, 0.01))
        
        # Should not match with stricter tolerance
        self.assertFalse(self.masker.validate_rectangles_match(rectangles1, rectangles2, 0.001))
    ...
    def test_validate_rectangles_match_different_length(self):
        ...
        self.assertFalse(self.masker.validate_rectangles_match(rectangles1, rectangles2))
