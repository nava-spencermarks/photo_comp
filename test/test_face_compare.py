...
class TestFaceComparator(unittest.TestCase):
    ...
    def create_test_image(
        self, filename, width=200, height=200, has_face_pattern=False
    ):
        ...
        if has_face_pattern:
            ...
            draw.ellipse(
                [
                    ...
                    center_y - eye_offset - eye_radius,
                    center_x - eye_offset + eye_radius,
                    center_y - eye_offset + eye_radius,
                ],
                fill="black",
    ...
    def test_identical_images(self):
        ...
        self.assertTrue(
            os.path.exists(image1_path), f"Required test image missing: {image1_path}"
        )
    ...
    def test_different_images(self):
        ...
        self.assertTrue(
            os.path.exists(image2_path), f"Required test image missing: {image2_path}"
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def test_known_same_vs_different(self):
        ...
        if os.path.exists("test_data/face_me_1.png") and os.path.exists(
            "test_data/me_different.png"
        ):
            test_cases.append(
                (
                    "test_data/face_me_1.png",
        ...
        for img1, img2, expected_same, description in test_cases:
            ...
            if expected_same:
                self.assertTrue(
                    is_same, f"Expected same person but got different: {details}"
                )
            else:
