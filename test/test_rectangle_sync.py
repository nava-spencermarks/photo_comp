...
class RectangleSyncTestCase(unittest.TestCase):
    ...
    def test_drawing_preview_sync_functionality(self):
        ...
        self.assertIn('otherCtx.fillRect(scaledStartX, scaledStartY, scaledWidth, scaledHeight);', html_content)
    ...
    def test_rectangle_drawer_initialization(self):
        ...
        self.assertIn('canvas1_drawer = new RectangleDrawer(canvasId, previewId);', html_content)
        self.assertIn('canvas2_drawer = new RectangleDrawer(canvasId, previewId);', html_content)
